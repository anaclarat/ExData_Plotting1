...
par(mfrow = c(2,2),mar= c(4,4,2,1),oma=c(6,6,4,2))
...
##Second plot
plot(as.numeric(subdata$Voltage)~subdata$DateTime,xlab = "",
     ylab = 'Voltage',type='l')
...
##Fourth plot
plot(as.numeric(subdata$Global_reactive_power)~subdata$DateTime,xlab = "",
